...
# Para ver su utilidad, en esta lección vamos a desarrollar un ejemplo. 
# Partiremos de una clase sin herencia con muchos atributos 
# y la iremos descomponiendo en otras clases más simples que nos permitan trabajar mejor con sus datos.

# Ejemplo sin herencia
# Hace muchos años me vi en la necesidad de diseñar una estructura para una tienda 
# que vendía tres tipos de productos: adornos, alimentos y libros.

# Todos los productos de la tienda tenían una serie de atributos comunes, 
# como la referencia, el nombre, el pvp... pero algunos eran específicos de cada tipo.
...
# ADORNO
# Obviamente esto es un despropósito, así que veamos como aproecharnos de 
# la herencia para mejorar el planteamento.

# Superclases
# Así pues la idea de la herencia es identificar una clase base (la superclase) 
# con los atriutos comunes y luego crear las demás clases heredando de ella (las subclases) extendiendo sus campos específicos. En nuestro caso esa clase sería el Producto en sí mismo:
...
# ISBN            0-123456-78-9
# AUTOR           Doña Juana
# Luego en los ejercicios os mostraré como podemos sobreescribir 
# el constructor de una forma eficiente para inicializar campos extra, 
# por ahora veamos como trabajar con estos objetos de distintas clases de forma común.

# Trabajando en conjunto
# Gracias a la flexibilidad de Python podemos manejar objetos de distintas clases 
...
# Polimorfismo
# El polimorfismo es una propiedad de la herencia por la que objetos de distintas 
# subclases pueden responder a una misma acción.

# La polimorfia es implícita en Python, ya que todas las clases 
# son subclases de una superclase común llamada Object.
