...
# No es santo de mi devoción porque no le veo mucho sentido,
# pero si venís de otros lenguajes quizá os interesa conocerla.
# La encapsulación consiste en denegar el acceso a los atributos 
# y métodos internos de la clase desde el exterior. En Python no existe, 
# pero se puede simular precediendo atributos y métodos con dos barras bajas
# __ como indicando que son "especiales".
...
# ¿Qué sentido tiene esto en Python? Ninguno, 
# porque se pierde toda la gracia de lo que en esencia es el lenguaje: 
# flexibilidad y polimorfismo sin control(hablaremos de esto más adelante).
