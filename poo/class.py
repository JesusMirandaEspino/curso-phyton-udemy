...
# Podéis imaginaros los objetos como un nuevo tipo de dato 
# cuya definición viene dada en una estructura llamada clase.
# Suelo hacer una metáfora y comparar las clases con moldes de galletas 
# y los objetos con las galletas en sí mismas. 
# Si bien todas las galletas que se hacen con el mismo molde tienen la misma forma, 
# cada una adquiere atributos individuales después del horneado. 
...
# Esta es una definición muy simple de lo que es una galleta, 
# ya que con el pass la dejo vacía. Luego añadiremos más información, 
# por ahora veamos como crear galletas con este molde.
# Instancias de clase
...
# sólo durante la ejecución del programa y se almacenan en la memoria del sistema operativo.
...
# Este proceso de "crear" los objetos en la memoria se denomina instanciación 
# y para realizarlo es tan fácil como llamar a la clase como si fuera una función:
...
# demostrando que están en lugares distintos de la memoria. 
...
# <class '__main__.Galleta' >
# <class '__main__.Galleta' >
# A su vez las clases tienen un atributo especial name que nos 
# devuelve su nombre en forma de cadena sin adornos:
